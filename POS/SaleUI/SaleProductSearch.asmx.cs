...
{
    /// <summary>
    /// Summary description for SaleProductSearch
    /// </summary>
    ...
    public class SaleProductSearch : System.Web.Services.WebService
    {
        private IDataAccess objDataAccess;
        private DbCommand objDbCommand;

        [WebMethod]
        public List<string> SaleSearchProduct(string productName)
        {
