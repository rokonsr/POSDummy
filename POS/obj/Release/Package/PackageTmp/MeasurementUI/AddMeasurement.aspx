...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <table>
        <tr>
            ...
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtMeasurementName" ForeColor="Red" runat="server" ErrorMessage="Required Field!"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
