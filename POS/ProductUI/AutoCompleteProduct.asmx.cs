...
{
    /// <summary>
    /// Summary description for AutoCompleteProduct
    /// </summary>
    ...
    public class AutoCompleteProduct : System.Web.Services.WebService
    {
        private IDataAccess objDataAccess;
        private DbCommand objDbCommand;

        [WebMethod]
        public List<string> GetSearchProduct(string productName)
        {
